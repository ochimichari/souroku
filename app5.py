...
if folders:
    ...
    st.markdown(
        f"""
        <script>
        const audio = document.querySelector('#audio-root audio'), timeDisplay = document.getElementById('time-view'), canvas = document.getElementById('timeline-canvas'), hoverInfo = document.getElementById('hover-info');
        ...
        div.log-outer {{ background-color: #161b22 !important; border: 1px solid #21262d !important; border-radius: 8px !important; padding: 10px !important; max-height: 380px !important; overflow-y: auto !important; width: 100% !important; display: block !important; box-sizing: border-box; }}
        ...
        .log-line:hover .txt {{ color: #ffffff; }}
        .ts {{ color: #00b4d8; font-family: monospace; margin-right: 15px; white-space: nowrap; font-weight: bold; }}
        .txt {{ color: #c9d1d9; line-height: 1.4; }}
